...
class Visualizer:
    ...
    def visualize_prediction_batch(cls, spt_img_b, spt_mask_b, qry_img_b, qry_mask_b, pred_mask_b, cls_id_b, batch_idx, iou_b=None):
        spt_img_b = vis_utils.to_cpu(spt_img_b)
        spt_mask_b = vis_utils.to_cpu(spt_mask_b)
        qry_img_b = vis_utils.to_cpu(qry_img_b)
        qry_mask_b = vis_utils.to_cpu(qry_mask_b)
        pred_mask_b = vis_utils.to_cpu(pred_mask_b)
        cls_id_b = vis_utils.to_cpu(cls_id_b)
